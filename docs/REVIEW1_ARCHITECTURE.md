...
Sources: [architecture](ARCHITECTURE.md), [data card](DATA_CARD.md), [model card](MODEL_CARD.md), [README](../README.md), [config](../configs/development_training.yaml), [E2 report](../reports/development_random_e2_summary.json), [E1 report](../reports/development_random_e1_summary.json), and [ImageNet origin](../reports/shared_imagenet_warmstart_summary.json). No final-test results or submission steps are inferred.
