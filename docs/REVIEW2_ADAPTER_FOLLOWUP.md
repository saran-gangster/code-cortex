...
This experiment tests controlled variants of the selected E2 image-plus-state model. E3 and E4 start from the stronger E2 checkpoint. Every visual-detector tensor is frozen and verified byte-for-byte after training; only the residual FiLM adapter changes.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| E2 image + state | 0.1698 | 0.0665 | 0.45 | 0.5257 | 0.3939 | 0.4503 | 0.2906 |
| E1 image only | 0.1146 | 0.0445 | 0.45 | 0.2220 | 0.2900 | 0.2515 | 0.1438 |
...
**Decision:** The highest development AP50 remains E2 image + state at 0.1698.
