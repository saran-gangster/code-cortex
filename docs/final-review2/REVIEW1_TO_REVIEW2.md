...
| Compute | Matched experiments | E2 and E1 trained in parallel on both Kaggle T4 GPUs with PyTorch Lightning |
| Early conclusion | E1 looked promising: AP50 0.0692 vs E2 0.0120 | Full pass reversed the ranking: E2 0.1698 vs E1 0.1146 |
| Root-cause work | Not yet available | Correct, masked, and shifted-state stress tests exposed visual-weight drift in E1 |
| Corrective experiments | Not yet available | E3/E4 froze and byte-verified E2 visual weights; only the state adapter trained |
| Final development decision | Continue testing state fusion | E4 reached 0.1697 but did not beat E2; keep E2 |
...
- We had a clear problem statement and a matched E2 versus E1 architecture.
- Both arms had completed 5,000 pilot updates.
- E1 appeared stronger in the early development recording.
...
3. **We accepted a changed conclusion:** the full-pass evidence showed that E2 is stronger than jointly trained E1.
4. **We diagnosed the failure:** stress tests and frozen-visual adapters isolated visual-weight drift.
5. **We made a conservative decision:** E2 remains selected because E4 did not beat it.
